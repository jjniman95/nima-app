...
class _MyProfileScreenState extends State<MyProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    if (doc.exists) {
      ...
      locationAllowed = data['locationAllowed'] == true;
            ...
            children: [
                      ...
                      child: _profileImage == null || ghostMode
                          ? Text(
                              nicknameController.text.trim().isNotEmpty
                                  ? nicknameController.text.trim()[0].toUpperCase()
                                  : 'N',
              ...
              _SectionCard(
                ...
                child: SwitchListTile(
                  ...
                  subtitle: Text(
                    'Hide your profile picture from everyone.',
              ...
              _SectionCard(
                ...
                child: SwitchListTile(
                  ...
                  onChanged: (value) => setState(() => locationAllowed = value),
                ),
              ),
              const SizedBox(height: 12),
              _SectionCard(
