...
class _NearbyScreenState extends State<NearbyScreen> {
  ...
  Future<void> _loadLocalUser() async {
    ...
    setState(() {
      ...
      localProfileThumbBase64 = prefs.getString('localProfileThumbBase64');
    });
  }
  ...
  Future<void> _openProfileMenu() async {
    final prefs = await SharedPreferences.getInstance();
    final thumbBase64 = prefs.getString('localProfileThumbBase64');
  ...
  void _showUserActions({
    ...
    required String? profileThumbBase64,
  }) {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                NimaAvatar(
                  nickname: nickname,
                  imageBase64: profileThumbBase64,
  ...
  bool _isVisiblePulse(Map<String, dynamic> data) {
    if (data['ghostMode'] == true) return false;
              ...
              child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final users = snapshot.data!.docs.where((doc) {
                    if (doc.id == localUserId) return false;
                    return _isVisiblePulse(doc.data());
                  }).toList();
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  ...List.generate(visibleCount, (index) {
                                    ...
                                    final profileThumbBase64 =
                                        data['profileThumbBase64']?.toString();
...
class _RadarUserBubble extends StatelessWidget {
  const _RadarUserBubble({
    required this.nickname,
    required this.profileThumbBase64,
  ...
  final String nickname;
  final String? profileThumbBase64;
